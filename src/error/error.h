...
/*
A function to simply create an error. Supports printf style format string and
NULL message
*/
...
/*
A function to concisely log an error to stderr without exiting. Will not log if
code is 0.
*/
int warn(const Error e);

/*
A function to exit because of an error. Will not exit if the code of the Error
is 0.
*/
